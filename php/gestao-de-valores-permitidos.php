                ...
                else
                {
                    ...
                    while($imprime_nome_estado_subitemAllowedValue = $conexao_query_para_obter_nome_estado_do_subitemAllowedValue->fetch_assoc())
                    {
                        ...
                        if($estado == 'active')
                        {
                            ...
                            echo "<a href='/sgbd/edicao-de-dados?estado=desativar&tipo=" . $value . "&id=" . $idValorPermitido . "&idSubitem=" . $idSubitem . "&origem=gestao-de-valores-permitidos'>[desativar]</a>";
                            echo "<a href='/sgbd/edicao-de-dados?estado=apagar&tipo=" . $value . "&id=" . $idValorPermitido . "&idSubitem=" . $idSubitem . "&origem=gestao-de-valores-permitidos'>[apagar]</a>";
                            echo '</td>';
                        }
                        else
                        {
                            echo '<td>';
                            echo "<a href='/sgbd/edicao-de-dados?estado=editar&tipo=" . $value . "&id=" . $idValorPermitido . "&idSubitem=" . $idSubitem . "&origem=gestao-de-valores-permitidos'>[editar]</a>";
                            echo "<a href='/sgbd/edicao-de-dados?estado=ativar&tipo=" . $value . "&id=" . $idValorPermitido . "&idSubitem=" . $idSubitem . "&origem=gestao-de-valores-permitidos'>[ativar]</a>";
                            echo "<a href='/sgbd/edicao-de-dados?estado=apagar&tipo=" . $value . "&id=" . $idValorPermitido . "&idSubitem=" . $idSubitem . "&origem=gestao-de-valores-permitidos'>[apagar]</a>";
                            echo '</td>';
                        }
                        echo '</tr>';
